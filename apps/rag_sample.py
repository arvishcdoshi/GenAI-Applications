...
loader = WebBaseLoader(
  web_paths=["https://www.codehelp.in/course/dsa-supreme-3.0"]
)
docs = loader.load()
...
vectorstore = Chroma(collection_name="codehelp_dsa_bootcamp_info", embedding_function=embeddings, persist_directory="./chroma_genai")
...
def retrieve_context(query: str):
  """Search for info related to codehelp dsa bootcamp"""
  try:
      embeddings = GoogleGenerativeAIEmbeddings(model="models/gemini-embedding-001")
      ...
      vector_store = Chroma(
          collection_name="codehelp_dsa_bootcamp_info",
...
input_message = (
  "give me the names of instructors of CodeHelp DSA bootcamp"
)
